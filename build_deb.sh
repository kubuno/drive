...
#   /usr/lib/kubuno/modules/drive/{kubuno-drive, module.toml, frontend/}
#   /usr/share/kubuno/modules/drive/migrations/*.sql
#   /etc/kubuno/modules/drive/config.toml.example
#
# Usage :
